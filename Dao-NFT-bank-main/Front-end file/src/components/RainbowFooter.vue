<template>
  <div class="page-footer">
    <div class="page-footer-part3">
      Copyright@2021 LOkesh JOshi
    </div>
    <div class="page-footer-part2 ">
      <div class="icon-box">
        <span></span>
        <a class="icon" href="https://t.me/Lokeshjoshi" target="_blank">
      ...
      <div class="icon-box">
        <span></span>
        <a class="icon" href="https://medium.com/Lokeshjoshi" target="_blank">
      ...
      <div class="icon-box">
        <span></span>
        <a class="icon" href="https://discord.gg/LokeshJoshi" target="_blank">
      ...
      <div class="icon-box">
        <span></span>
        <a class="icon" href="https://github.com/lokeshjoshi01" target="_blank">
